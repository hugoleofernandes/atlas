...
) : AtlasEndpoint<FakeLoginRequest, FakeLoginResponse>
{
    ...
    public override async Task HandleAsync(FakeLoginRequest req, CancellationToken ct)
    {
