...
public sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> b)
    {
        ...
        b.Property(x => x.AttemptNumber).IsRequired().HasDefaultValue(1);
        ...
        b.HasIndex(x => x.IdempotencyKey).IsUnique(false);
        ...
        b.Property(x => x.TraceParent).HasMaxLength(55).IsRequired(false);
        ...
        b.Property(x => x.UserEmail).HasMaxLength(254).IsRequired(false);
