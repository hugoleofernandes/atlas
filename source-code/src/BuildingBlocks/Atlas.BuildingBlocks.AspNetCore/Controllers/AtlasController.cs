...
namespace Atlas.BuildingBlocks.AspNetCore.Controllers;

/// <summary>
/// Base controller that exposes explicit helpers for converting application results
/// into the public HTTP response contract.
/// </summary>
public abstract class AtlasController : ControllerBase
{
    protected IErrorMessageLocalizer ErrorLocalizer { get; }
    private readonly IHttpResultMapper _resultMapper;

    protected AtlasController(
