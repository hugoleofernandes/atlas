...
public sealed class IdentityResubmitDeadLetterEndpoint(
    IIdentityResubmitDeadLetterCommandHandler handler,
    IHandlerInvoker invoker)
    : AtlasEndpoint<ResubmitDeadLetterRequest, ResubmitDeadLetterResponse>
{
    public override void Configure()
    {
        Post("bff/v1/outbox/identity/dead-letters/{Id}/resubmit");
        Policies($"permission:{IdentityModulePermissions.Outbox.Resubmit}");
