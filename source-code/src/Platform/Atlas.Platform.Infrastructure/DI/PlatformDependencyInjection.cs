...
using Atlas.Platform.Infrastructure.Readers.Lookups.LookupStatuses;
...
public static class PlatformDependencyInjection
{
    public static IServiceCollection AddPlatformModuleDependencies(this IServiceCollection services)
    {
        ...
        services.AddScoped<IPlatformLookupLabelLocalizer, PlatformLookupLabelLocalizer>();
        ...
        services.AddScoped<ILookupStatusesReader, LookupStatusesReader>();
        ...
        services.AddScoped<ILookupStatusesQueryHandler, LookupStatusesQueryHandler>();
