...
namespace Atlas.Platform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260611201231_Initial2_Platform")]
    partial class Initial2_Platform
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("atlas_platform")
            ...
            modelBuilder.Entity("Atlas.BuildingBlocks.Persistence.Entities.Audits.Audit", b =>
                {
                    ...
                    b.ToTable("audits", "atlas_platform");
                });
            ...
            modelBuilder.Entity("Atlas.Platform.Domain.Modules.EntityType", b =>
                {
                    ...
                    b.HasIndex("ModuleId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_entity_types_module_id_name");

                    b.ToTable("entity_types", "atlas_platform");
                });

            modelBuilder.Entity("Atlas.Platform.Domain.Modules.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("modules", "atlas_platform");
                });

            modelBuilder.Entity("Atlas.Platform.Domain.Systems.AtlasSystem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_systems_name");

                    b.ToTable("systems", "atlas_platform");
                });

            modelBuilder.Entity("Atlas.Platform.Domain.Tenants.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("tenants", "atlas_platform");

                    b.HasAnnotation("Audit:EntityTypeId", new Guid("00000000-0000-0000-0002-000000000001"));
                });
            ...
            modelBuilder.Entity("Atlas.SharedKernel.Application.OutboxMessages.OutboxHandlerExecution", b =>
                {
                    ...
                    b.ToTable("outbox_handler_executions", "atlas_platform");
                });
            ...
            modelBuilder.Entity("Atlas.Platform.Domain.Modules.EntityType", b =>
                {
                    b.HasOne("Atlas.Platform.Domain.Modules.Module", null)
                        .WithMany()
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_entity_types_modules_module_id");
                });
            ...
            modelBuilder.Entity("Atlas.SharedKernel.Application.OutboxMessages.OutboxHandlerExecution", b =>
                {
                    b.HasOne("Atlas.SharedKernel.Application.OutboxMessages.OutboxMessage", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbox_handler_executions_outbox_message_outbox_message_id");
                });
