...
/// </summary>
public sealed class HttpGetPendingMessagesReader : IGetPendingMessagesReader
{
    private readonly IInternalApiInvoker _internalApiInvoker;
    private readonly string _url;

    public HttpGetPendingMessagesReader(
        ...
        CancellationToken ct)
    {
        ...
        var result = await _internalApiInvoker.InvokeAsync<List<OutboxMessageDto>>(request, ct);
